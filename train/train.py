...
from utils import init_pretrain_weights
...
if __name__ == '__main__':
    ...
    if 'pretrain' in setup_args:
        print('Loading pretrain:', setup_args['pretrain'])
        checkpoint = torch.load(
             setup_args['pretrain'], map_location=lambda storage, location: storage)
        if 'freeze_upto' in setup_args:
            model = init_pretrain_weights(model, checkpoint, freeze_upto=setup_args['freeze_upto'])
        else:
            model = init_pretrain_weights(model, checkpoint)
