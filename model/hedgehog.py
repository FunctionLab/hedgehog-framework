...
def criterion():
    ...
    NOTE: This is a placeholder function to avoid requiring torchsort
    dependency across all steps in this repository. The loss function
    is available at `spearman_by_track_default` in `../train/loss_functions.py`
    """
    return None
