# Wreath Model Interpretation

This directory contains scripts for interpreting the Wreath model using DeepLIFT/DeepSHAP attribution methods and TF-MoDISco motif discovery. These tools help identify which sequence features (motifs) the model uses to make predictions.
...
- **Targets**: `example/wreath_track_inds.txt` - 11 methylation profile indices (116, 123, 131, 132, 140, 142, 150, 151, 157, 160, 163)
...
**Key features**:
- Works directly with Wreath model architecture
...
└── example/                       # Example data and workflow
    ...
    ├── wreath_track_inds.txt    # 11 target indices
